...
CHANNEL_LINK = os.environ.get("CHANNEL_LINK", "-1001981603944")
#your id of telegram can be found by https://t.me/MissRose_bot with '/id' command
OWNER_ID = int(os.environ.get("OWNER_ID", "7092346282"))
#port set to default 8080
PORT = os.environ.get("PORT", "8080")
#your database url mongodb only You can use mongo atlas free cloud database
DB_URL = os.environ.get("DB_URL", "mongodb+srv://Bapusarkarbjppvt:HU8jDvgoGuUJv6yI@cluster0.khf1x.mongodb.net/")
#your database name
DB_NAME = os.environ.get("DB_NAME", "Filesbybaousj")
...
OWNER_TAG = os.environ.get("OWNER_TAG", "JBL_TOXIC")
#Time in seconds for message delete
TIME = int(os.environ.get("TIME", "60"))


# add premium logs channel id
PAYMENT_LOGS = int(environ.get('PAYMENT_LOGS', '-1002017483928'))
...
SHORTLINK_API_URL = os.environ.get("SHORTLINK_API_URL", "shortyfi.link")
# SHORTLINK_API_KEY = os.environ.get("SHORTLINK_API_KEY", "")
#use this key if not working ☠️ (jokin!!)
SHORTLINK_API_KEY = os.environ.get("SHORTLINK_API_KEY", "6ea45e31941204014975566c1a788f0492935434")
#add your custom time in secs for shortlink expiration.
# 24hr = 86400
# 12hr = 43200
VERIFY_EXPIRE = int(os.environ.get('VERIFY_EXPIRE', "86400")) # Add time in seconds
#Tutorial video for the user of your shortner on how to download.
TUT_VID = os.environ.get("TUT_VID","https://t.me/c/2091520425/43")
